...
SOURCE_ACCOUNTS = []'Dashpay', 'realdonaldtrump',
...
# What order of the Markov model to use. Higher values yield higher complexity
...
WEB_CONTEXT = ['example.com']
# A list of dictionaries containing the attributes for each page.
WEB_ATTRIBUTES = [{}]
# The name of the account you're tweeting to.
TWEET_ACCOUNT = ''

# Words to use instead of '@' references to other users
# Mainly meant to preserve coherency in the original tweet
REPLACE_WORDS = ['person']
